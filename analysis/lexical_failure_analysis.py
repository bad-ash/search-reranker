...
DEFAULT_SUMMARY_OUTPUT = Path("artifacts/eval/bm25_failure_summary.json")
DEFAULT_DETAILS_OUTPUT = Path("artifacts/eval/bm25_failure_details.json")
...
def matched_terms(
    ...
    return [
        (term, term_idf(term, artifact), candidate_term_frequencies[term])
...
def build_failure_record(query_diagnostic: dict[str, Any], artifact: BM25Artifact) -> dict[str, Any]:
    features = compute_failure_features(query_diagnostic, artifact.average_document_length)
